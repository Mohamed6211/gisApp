 ...
 L.EditToolbar.Delete = L.Handler.extend({
	 ...
	 enable: function () {
		 if (this._enabled || !this._hasAvailableLayers()) {
			 ...
			 swal.fire("select a feature to remove")
			 deleteStopKey=1;
			 console.log(L.Toolbar2.EditAction.Control.Delete.actions)
			 // this.editing.save();
		 ...
		 // 	.on('layerremove', this._disableLayerDelete, this);
			 ...
			 console.log(this._deletedLayers)
	 ...
	 revertLayers: function () {
		 ...
		 console.log(this._deletedLayers);
		 // drawnItems.addLayer(this._deletedLayers)
		 for(t of this._deletedLayers)
		 {
			 map.addLayer(t);
			 setZindexItem2(t);		
		 }
	 ...
	 save: function () {
		 deleteStopKey=1;
		 if(typeof(this._deletedLayers)!='undefined')
		 {
			 for(t of this._deletedLayers)
			 {
			 drawnItems.removeLayer(t)
			 map.removeLayer(t)
			 ...
			 for(f of lyrsT)
			 {
				 ...
				 lyrsT[parc] = lyrsT[parc].filter(function(item){return item !== undefined })
				 parc++;
			 }
		 }
	 ...
	 _disableLayerDelete: function (e) {
		 ...
		 // drawnItems.removeLayer(this._deletedLayers)
	 },
