// Crea una clase para el plugin
    L.Control.MeasurePolygon = L.Control.extend({
        options: {
            ...
            html_template: `<p><strong><span style="text-decoration: underline;">Mesures</span></strong></p>
<p><strong>Aire: </strong><br>_p_area</p>
<p><strong>Perimètre : </strong><br>_p_perimetro</p>`,
            height: 130,
            width: 150,
            color_polygon: 'black',
            fillColor_polygon: 'white',
            weight_polygon: '5',
        ...
        _UpdateAreaPerimetro(layer) {
            ...
            const area = (L.GeometryUtil.geodesicArea(latlngs)/1000000).toFixed(3);
            ...
            let areaValue = `${area} km²`;
            let perimeterValue = `${perimeter} m`;
